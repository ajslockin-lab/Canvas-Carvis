...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col font-sans overflow-hidden selection:bg-primary/30">
      ...
      />
      <div className="pointer-events-none fixed inset-0 opacity-10 bg-[radial-gradient(circle_at_center,transparent_0%,#060911_100%)]" />
      ...
      <header className="px-8 py-6 flex items-center justify-between z-10">
        ...
        <nav className="flex gap-4">
          <Link href="/signin">
            <Button
              variant="outline"
              className="font-mono rounded-none border-border bg-transparent text-muted-foreground hover:text-primary hover:border-primary/50 uppercase text-xs tracking-wider"
            >
              Init_Session
            </Button>
          </Link>
      ...
      <main className="flex-1 flex flex-col items-center justify-center relative z-10 px-6">
        ...
        <div className="text-center max-w-3xl relative z-10 mt-12">
          ...
          <p className="text-lg text-muted-foreground mb-10 max-w-xl mx-auto leading-relaxed">
            Not a productivity tool. A heads-up display for your Canvas LMS.
            Connect your courses, talk to your data, and execute assignments
          ...
          <Link href="/signin">
            <Button
              size="lg"
              className="h-14 px-8 text-sm font-mono tracking-widest uppercase rounded-none bg-card border border-primary text-primary hover:bg-primary hover:text-primary-foreground transition-all duration-300 group"
            >
              Establish Uplink
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 border-t border-border z-10 bg-background/80 backdrop-blur">
        <div className="p-8 border-r border-border hover:bg-card/50 transition-colors">
          ...
          <h3 className="font-mono text-sm tracking-widest uppercase mb-2">
            Total Sync
          </h3>
          <p className="text-sm text-muted-foreground">
            Real-time data extraction from Canvas LMS. Assignments, grades, and
            syllabi loaded directly into memory.
          </p>
        </div>
        <div className="p-8 border-r border-border hover:bg-card/50 transition-colors">
          ...
          <p className="text-sm text-muted-foreground">
            Natural language queries via the CARVIS terminal. Ask about
            deadlines, summarize materials, formulate action plans.
          </p>
        </div>
        <div className="p-8 hover:bg-card/50 transition-colors">
          ...
          <p className="text-sm text-muted-foreground">
            Zero friction, pure signal. Dense information architecture designed
            for high-performance students.
          </p>
        </div>
      </div>
    </div>
