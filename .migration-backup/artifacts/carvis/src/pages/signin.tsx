...
const patSchema = z.object({
  canvasUrl: z.string().url("Must be a valid URL (e.g., https://canvas.instructure.com)"),
  pat: z.string().min(10, "PAT looks too short. Provide a valid Personal Access Token."),
});
...
export default function SignIn() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-4">
      ...
      <div className="pointer-events-none fixed inset-0 opacity-[0.02]" style={{ backgroundImage: 'linear-gradient(rgba(255, 255, 255, 0.5) 1px, transparent 1px), linear-gradient(90deg, rgba(255, 255, 255, 0.5) 1px, transparent 1px)', backgroundSize: '20px 20px' }}></div>
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-muted-foreground text-sm font-mono tracking-wider mt-2">Enter credentials to proceed</p>
        </div>
        ...
        <Card className="rounded-none border-border bg-card shadow-2xl shadow-primary/5">
          <CardHeader className="border-b border-border bg-muted/20 pb-4">
            ...
            <CardDescription className="font-mono text-xs">
              Generate a Personal Access Token in your Canvas Account Settings &gt; Approved Integrations.
            </CardDescription>
          </CardHeader>
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="font-mono text-xs text-muted-foreground uppercase tracking-wider">Institution URL</FormLabel>
                      <FormControl>
                        <Input 
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="font-mono text-xs text-muted-foreground uppercase tracking-wider">Personal Access Token</FormLabel>
                      <FormControl>
                ...
                >
                  {patMutation.isPending ? "Authenticating..." : "Initialize Link"}
                </Button>
              </form>
            </Form>
          </CardContent>
